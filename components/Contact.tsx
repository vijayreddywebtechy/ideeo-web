      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="fade-in-section space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <a href="mailto:hello@ideeotechsolutions.com" className="flex items-center gap-3 text-body font-outfit hover:text-primary transition-colors">
                  <div className="w-10 h-10 rounded-xl bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800/30 flex items-center justify-center flex-shrink-0">
            ...
            {/* Availability badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-surface dark:bg-surface-100 border border-surface-200 shadow-card">
